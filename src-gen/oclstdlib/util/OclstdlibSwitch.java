...
public class OclstdlibSwitch<T1> extends Switch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		...
		case OclstdlibPackage.OCL_COMPARABLE: {
			...
			if (result == null)
				result = caseOclAny(oclComparable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case OclstdlibPackage.OCL_ENUMERATION: {
			...
			if (result == null)
				result = caseOclAny(oclEnumeration);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OclstdlibPackage.OCL_INVALID: {
			...
			if (result == null)
				result = caseOclVoid(oclInvalid);
			if (result == null)
				result = caseOclAny(oclInvalid);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case OclstdlibPackage.OCL_STEREOTYPE: {
			...
			if (result == null)
				result = caseOclType(oclStereotype);
			if (result == null)
				result = caseOclElement(oclStereotype);
			if (result == null)
				result = caseOclAny(oclStereotype);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case OclstdlibPackage.OCL_TYPE: {
			...
			if (result == null)
				result = caseOclElement(oclType);
			if (result == null)
				result = caseOclAny(oclType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case OclstdlibPackage.ORDERED_SET: {
			...
			if (result == null)
				result = caseUniqueCollection(orderedSet);
			if (result == null)
		...
		case OclstdlibPackage.SET: {
			...
			if (result == null)
				result = caseUniqueCollection(set);
			if (result == null)
		...
		case OclstdlibPackage.UNIQUE_COLLECTION: {
			...
			if (result == null)
				result = caseCollection(uniqueCollection);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
