...
public class PrivacyDataImpl extends NamedElementImpl implements PrivacyData {
	 ...
	 * @ordered
	 */
	protected static final DataType TYPE_EDEFAULT = DataType.BIOMETRIC;
	...
	public void setType(DataType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrivacyModelPackage.PRIVACY_DATA__TYPE, oldType,
					type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PrivacyModelPackage.PRIVACY_DATA__TYPE:
			return getType();
		}
